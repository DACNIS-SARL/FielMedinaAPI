...
def get_translation(lang: str, key: str) -> str:
    ...
    translations = NOTIFICATION_TRANSLATIONS.get(lang, NOTIFICATION_TRANSLATIONS[DEFAULT_LANGUAGE])
    return translations.get(key, NOTIFICATION_TRANSLATIONS[DEFAULT_LANGUAGE].get(key, ''))
    ...
    def send_new_tip_notification(tip) -> None:
        ...
        try:
            ...
            for lang, tokens in device_groups.items():
                ...
                description = getattr(tip, f'description_{lang}', None) or tip.description or ''
