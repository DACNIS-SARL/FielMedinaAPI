...
@receiver(post_save, sender="guard.Location")
...
@receiver(post_save, sender="guard.Event")
...
@receiver(post_save, sender="guard.Hiking")
...
@receiver(post_save, sender="guard.Tip")
